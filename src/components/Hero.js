      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-8 pb-32 sm:pb-48 lg:pb-56">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
          ...
          >
            ...
            >
              DedicatedIT undergraduate with a solid foundation in software engineering and quality assurance. Skilled in MERN stack development and software testing, with a passion for building efficient, reliable, and high-quality applications while continuously learning and contributing to impactful projects.
            </motion.p>
